...
// Solo admins pueden llegar hasta aquí
...
// Aquí ya puedes continuar con tu lógica del cambio de contraseña
$DIAS_ESPERA = 30; // Cambiar contraseña cada 30 días

// Consultar la contraseña y la fecha del último cambio
    ...
    if (isset($_POST['change'])) {
        if (!$puedeCambiar) {
            ...
            if (password_verify($oldpass, $userData['password'])) {
                ...
                $update = $dbh->prepare("UPDATE user SET password = ?, password_last_changed = NOW() WHERE email = ?");
...
<!-- Font Awesome (mejor usar la versión oficial desde CDN, compatible con Bootstrap 5) -->
      ...
      <div class="container-fluid">
        ...
        <form name="form1" method="post" action="" onsubmit="return valid();" class="needs-validation" novalidate>
          <div class="card shadow-sm">
            <div class="card-body">
              <div class="mb-3 row">
                <label for="oldpass" class="col-sm-3 col-form-label">Contraseña Actual</label>
                <div class="col-sm-6">
                  <div class="input-group">
                    <span class="input-group-text"><i class="fa fa-unlock-alt"></i></span>
                    <input type="password" class="form-control" id="oldpass" name="oldpass" required minlength="6" />
                    <div class="invalid-feedback">
                      Por favor, ingresa tu contraseña actual (mínimo 6 caracteres).
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="mb-3 row">
                <label for="newpass" class="col-sm-3 col-form-label">Nueva Contraseña</label>
                <div class="col-sm-6">
                  <div class="input-group">
                    <span class="input-group-text"><i class="fa fa-unlock-alt"></i></span>
                    <input type="password" class="form-control" id="newpass" name="newpass" required minlength="6" />
                    <div class="invalid-feedback">
                      Por favor, ingresa la nueva contraseña (mínimo 6 caracteres).
                    </div>
                  </div>
                </div>
              </div>

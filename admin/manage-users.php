                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" name="email" class="form-control" required
                            pattern="^[a-zA-Z0-9._%+-]+@spe\.gob\.hn$" title="Debe ser un correo @spe.gob.hn">
                    </div>
                    <div class="col-md-6">
        ...
        <div class="modal-dialog">
            <form method="post" class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-muted small">Al aceptar, este usuario ya no tendrá acceso al sitio de Soporte
                        Técnico.</p>

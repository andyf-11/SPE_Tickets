  ...
  <div class="offcanvas-body d-flex flex-column p-0 h-100">
    ...
    <div class="text-center py-4 border-bottom bg-gradient-light" style="background: linear-gradient(135deg, #f8f9fc 0%, #e9ecef 100%);">
      <div class="position-relative d-inline-block">
        <img src="../assets/img/Logo-Gobierno_small.png" alt="Supervisor" class="rounded-circle border border-3 border-white shadow" width="90" height="90">
      ...
      <div class="mt-3">
        <h6 class="mb-1 fw-bold">SUPERVISOR</h6>
    ...
    <div class="flex-grow-1 overflow-auto py-3">
      ...
      <ul class="nav flex-column px-2 gap-1">
        <li class="nav-item">
          <a href="s_dashboard.php" class="nav-link rounded-3 px-3 py-2 d-flex align-items-center <?= ($page == 'dashboard') ? 'active bg-primary text-white shadow-sm' : 'text-dark hover-bg-light'; ?>">
        ...
        <li class="nav-item">
          <a href="tickets-status.php" class="nav-link rounded-3 px-3 py-2 d-flex align-items-center <?= ($page == 'tickets-status') ? 'active bg-primary text-white shadow-sm' : 'text-dark hover-bg-light'; ?>">
            <div class="icon-wrapper <?= ($page == 'tickets-status') ? 'bg-white text-primary' : 'bg-primary bg-opacity-10 text-primary'; ?> rounded-2 p-2 me-3">
              <i class="fas fa-clipboard-list fs-6"></i>
            </div>
            <span class="flex-grow-1">Estado de Tickets</span>
            <?php if($page == 'tickets-status'): ?>
              <i class="fas fa-chevron-right fa-xs ms-2"></i>
            <?php endif; ?>
          </a>
        </li>
    ...
    <div class="p-3 border-top text-center bg-light">
      <div class="d-flex justify-content-center gap-2 mb-2">
        <a href="#" class="text-secondary" data-bs-toggle="modal" data-bs-target="#tutorialModal" title="Tutorial de uso">

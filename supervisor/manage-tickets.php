            ...
            <form method="get">
                <div class="row g-3 align-items-center">
                    <div class="col-md-4 col-lg-3">
                        ...
                        <select class="form-select shadow-sm" id="filtro_edificio" name="filtro_edificio" onchange="this.form.submit()">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center flex-wrap gap-2">
                                            ...
                                            <span class="text-muted"><i class="far fa-calendar me-1"></i><?= $postingDate ?></span>
                                            <?php
                                            $badgeClass = 'secondary';
                                            $estadoTexto = ucfirst($status);
                                            if ($status === 'abierto') $badgeClass = 'primary';
                                            elseif ($status === 'en proceso') { $badgeClass = 'warning text-dark'; $estadoTexto='En Proceso'; }
                                            elseif ($status === 'cerrado') $badgeClass = 'success';
                                            ...
                                            ?>
                                            <span class="badge bg-<?= $badgeClass ?> ticket-status-badge"><?= $estadoTexto ?></span>
                                    ...
                                    <button class="btn btn-sm btn-outline-primary rounded-pill" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#ticket<?= $id ?>" aria-expanded="false" aria-controls="ticket<?= $id ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <?php if ($status !== 'cerrado'): ?>
                                            <a href="asignar_tickets.php?id=<?= $id ?>" class="btn btn-primary btn-sm rounded-pill">

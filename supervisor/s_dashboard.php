...
<body class="bg-light">
  ...
  <div class="d-flex">
    ...
    <!-- Contenido principal -->
    <main class="flex-grow-1 px-4 py-3 mt-5" style="margin-left: 10px;">
      <!-- Encabezado -->
      ...
      <!-- Sección adicional para estadísticas rápidas -->
      <div class="row g-4">
        <div class="col-lg-6">
            ...
            <div class="card-body">
              <div class="alert alert-warning d-flex align-items-center mb-3">
                ...
                <div>
                  ...
                  <p class="mb-0">Tienes <?= max(0, $solicitudes_nuevas - $solicitudes_enprogreso) ?> tickets nuevos
                    que requieren atención.</p>
                </div>
              </div>

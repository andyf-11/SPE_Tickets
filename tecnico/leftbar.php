...
<div class="offcanvas-md offcanvas-start bg-white shadow-sm" tabindex="-1" id="leftbar" style="--sidebar-accent: #4e73df; --sidebar-hover: #f8f9fc;">
  ...
  <div class="offcanvas-body d-flex flex-column p-0">
    ...
    <div class="text-center py-4 border-bottom bg-gradient-light">
      ...
      <div class="mt-3">
        ...
        <div class="fw-bold text-primary mt-1" style="letter-spacing: 0.5px;">TÉCNICO</div>
      </div>
    </div>
    ...
    <div class="px-3 pt-3 flex-grow-1 overflow-auto">
      ...
      <ul class="nav flex-column gap-2 px-2">
        <li class="nav-item">
          <a href="t_dashboard.php" class="nav-link rounded-3 px-3 py-2 d-flex align-items-center <?= ($page == 'home') ? 'active bg-primary text-white shadow-sm' : 'text-dark'; ?>">
            <i class="fas fa-chart-bar me-3 fs-5 <?= ($page == 'home') ? 'text-white' : 'text-secondary'; ?>"></i>
            <span>Dashboard</span>
            <?php if($page == 'home'): ?>
        ...
        <li class="nav-item">
          <a href="manage-tickets.php" class="nav-link rounded-3 px-3 py-2 d-flex align-items-center <?= ($page == 'manage-tickets') ? 'active bg-primary text-white shadow-sm' : 'text-dark'; ?>">
            <i class="fas fa-ticket-alt me-3 fs-5 <?= ($page == 'manage-tickets') ? 'text-white' : 'text-secondary'; ?>"></i>
        ...
        <li class="nav-item">
          <a href="tech-layout.php" class="nav-link rounded-3 px-3 py-2 d-flex align-items-center <?= ($page == 'tech-layout') ? 'active bg-primary text-white shadow-sm' : 'text-dark'; ?>">
            <i class="fas fa-users-cog me-3 fs-5 <?= ($page == 'tech-layout') ? 'text-white' : 'text-secondary'; ?>"></i>
            <span>Plantilla Técnicos</span>
        ...
        <li class="nav-item">
          <a href="chat-list-users.php" class="nav-link rounded-3 px-3 py-2 d-flex align-items-center <?= ($page == 'chat-list-users') ? 'active bg-primary text-white shadow-sm' : 'text-dark'; ?>">
            <i class="fas fa-comment me-3 fs-5 <?= ($page == 'chat-list-users') ? 'text-white' : 'text-secondary'; ?>"></i>
            <span>Consultas</span>
        ...
        <li class="nav-item">
          <a href="chat-list.php" class="nav-link rounded-3 px-3 py-2 d-flex align-items-center <?= ($page == 'chat-list') ? 'active bg-primary text-white shadow-sm' : 'text-dark'; ?>">
            <i class="fas fa-check me-3 fs-5 <?= ($page == 'chat-list') ? 'text-white' : 'text-secondary'; ?>"></i>
        ...
        <li class="nav-item">
          <a href="change-password.php" class="nav-link rounded-3 px-3 py-2 d-flex align-items-center <?= ($page == 'change-password') ? 'active bg-primary text-white shadow-sm' : 'text-dark'; ?>">
            <i class="fas fa-lock me-3 fs-5 <?= ($page == 'change-password') ? 'text-white' : 'text-secondary'; ?>"></i>

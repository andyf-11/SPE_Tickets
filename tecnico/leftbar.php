  ...
  <div class="offcanvas-body d-flex flex-column p-0">
    ...
    <div class="text-center py-4 border-bottom bg-gradient-light" style="background: linear-gradient(135deg, #f8f9fc 0%, #e9ecef 100%);">
      <div class="position-relative d-inline-block">
        <img src="../assets/img/Logo-Gobierno_small.png" alt="Perfil Admin" class="img-fluid rounded-circle border border-3 border-white shadow" style="width: 90px; height: 90px; object-fit: cover;">
      </div>
      <div class="mt-3">
        <div class="text-muted small">Bienvenid@</div>
        <div class="fw-bold text-dark mt-1" style="letter-spacing: 0.5px; font-size: 1.1rem;">
          <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-1 rounded-pill">TÉCNICO</span>
        </div>
      </div>
    </div>
    ...
    <div class="p-3 border-top text-center bg-light">
      <div class="d-flex justify-content-center gap-2 mb-2">
        <a href="change-password.php" class="text-muted"><i class="fas fa-question-circle"></i></a>

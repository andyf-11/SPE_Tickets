...
<button class="btn btn-primary d-md-none m-3 rounded-pill shadow-sm" type="button" data-bs-toggle="offcanvas"
...
<div class="offcanvas-md offcanvas-start bg-white shadow-sm" tabindex="-1" id="leftbar"
  style="--sidebar-accent: #4e73df; --sidebar-hover: #f8f9fc; width: 250px;">
  ...
  <div class="offcanvas-body d-flex flex-column p-0 h-100">
    ...
    <div class="text-center py-4 border-bottom bg-gradient-light"
      style="background: linear-gradient(135deg, #f8f9fc 0%, #e9ecef 100%);">
    ...
    <div class="flex-grow-1 overflow-auto py-3">
      <div class="px-3 mb-4 d-flex justify-content-between align-items-center">
        <span class="text-uppercase fw-bold small text-muted"
          style="letter-spacing: 1px; font-size: 0.7rem;">NAVEGACIÓN</span>
      ...
      <ul class="nav flex-column px-2 gap-1">
        <li class="nav-item">
          <a href="t_dashboard.php"
            class="nav-link rounded-3 px-3 py-2 d-flex align-items-center <?= ($page == 'home') ? 'active bg-primary text-white shadow-sm' : 'text-dark hover-bg-light'; ?>">
            <div
              class="icon-wrapper <?= ($page == 'home') ? 'bg-white text-primary' : 'bg-primary bg-opacity-10 text-primary'; ?> rounded-2 p-2 me-3">
        ...
        <li class="nav-item">
          <a href="manage-tickets.php"
            class="nav-link rounded-3 px-3 py-2 d-flex align-items-center <?= ($page == 'manage-tickets') ? 'active bg-primary text-white shadow-sm' : 'text-dark hover-bg-light'; ?>">
            <div
              class="icon-wrapper <?= ($page == 'manage-tickets') ? 'bg-white text-primary' : 'bg-primary bg-opacity-10 text-primary'; ?> rounded-2 p-2 me-3">
        ...
        <li class="nav-item">
          <a href="tech-layout.php"
            class="nav-link rounded-3 px-3 py-2 d-flex align-items-center <?= ($page == 'tech-layout') ? 'active bg-primary text-white shadow-sm' : 'text-dark hover-bg-light'; ?>">
            <div
              class="icon-wrapper <?= ($page == 'tech-layout') ? 'bg-white text-primary' : 'bg-primary bg-opacity-10 text-primary'; ?> rounded-2 p-2 me-3">
        ...
        <li class="nav-item">
          <a href="chat-list-users.php"
            class="nav-link rounded-3 px-3 py-2 d-flex align-items-center <?= ($page == 'chat-list-users') ? 'active bg-primary text-white shadow-sm' : 'text-dark hover-bg-light'; ?>">
            <div
              class="icon-wrapper <?= ($page == 'chat-list-users') ? 'bg-white text-primary' : 'bg-primary bg-opacity-10 text-primary'; ?> rounded-2 p-2 me-3">
        ...
        <li class="nav-item">
          <a href="chat-list.php"
            ...
            <div
              class="icon-wrapper <?= ($page == 'chat-list') ? 'bg-white text-primary' : 'bg-primary bg-opacity-10 text-primary'; ?> rounded-2 p-2 me-3">
